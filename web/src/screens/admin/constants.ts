...
export const NAV_GROUPS: NavGroup[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { id: 'field', label: 'Terrain & PV', icon: '🧾' },
            { id: 'pvVerification', label: 'Vérification PV', icon: '✅' },
...
export const TRANSLATIONS: Record<string, Record<string, string>> = {
    ...
    field: { fr: '🧾 Terrain & PV', en: '🧾 Field & PV' },
    pvVerification: { fr: '✅ Vérification PV', en: '✅ PV Verification' },
